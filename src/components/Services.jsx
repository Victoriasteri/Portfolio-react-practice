...
function Services() {
  return (
    <section className="flex max-lg:justify-center md:pt-[25px] max-md:pt-[45px]">
      <div
        className="flex flex-col max-lg:flex-row max-lg:items-baseline max-lg:justify-between
       max-md:flex-wrap"
      >
        ...
        <div className="flex items-start pt-10 max-lg:pl-[25px] max-md:pl-0">
          <img src={Icon2} />
          <div className="pl-[20px] max-lg:pl-[10px]">
